...
// The stub replaces the AXI4 master: descriptor fetches complete in 1 cycle
// with zeroed payload, and DM instructions complete in 1 cycle (dm_done pulse).
...
module movement_top #(
    ...
    assign df_in_full   = fetch_pending;   // back-pressure DF while pending
    assign df_out_empty = ~fetch_pending;
    assign df_out_dout  = '0;              // zeroed descriptor payload
    ...
    // Stub: accept DM instruction, pulse dm_done 1 cycle later.
