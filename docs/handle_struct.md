...
| Valid            | 1     | Handle is valid for this cycle / transfer |
| Descriptor size  | —     | Number of words to read; **fixed to 4** in this design (matches the four 32-bit words in [descriptor_struct.md](descriptor_struct.md)) |
