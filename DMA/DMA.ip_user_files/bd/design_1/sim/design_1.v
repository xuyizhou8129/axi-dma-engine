...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=5,da_mb_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (reset,
    sys_clock,
    usb_uart_rxd,
  ...
  design_1_DMA_0_0 DMA_0
       (.clk(microblaze_0_Clk),
        .irq_block(DMA_0_irq_block),
        ...
        .s_axil_init_araddr(axi_smc_M02_AXI_ARADDR),
        .s_axil_init_arprot(axi_smc_M02_AXI_ARPROT),
        .s_axil_init_arready(axi_smc_M02_AXI_ARREADY),
        .s_axil_init_arvalid(axi_smc_M02_AXI_ARVALID),
        .s_axil_init_awaddr(axi_smc_M02_AXI_AWADDR),
        .s_axil_init_awprot(axi_smc_M02_AXI_AWPROT),
        .s_axil_init_awready(axi_smc_M02_AXI_AWREADY),
        .s_axil_init_awvalid(axi_smc_M02_AXI_AWVALID),
        .s_axil_init_bready(axi_smc_M02_AXI_BREADY),
        .s_axil_init_bresp(axi_smc_M02_AXI_BRESP),
        .s_axil_init_bvalid(axi_smc_M02_AXI_BVALID),
        .s_axil_init_rdata(axi_smc_M02_AXI_RDATA),
        .s_axil_init_rready(axi_smc_M02_AXI_RREADY),
        .s_axil_init_rresp(axi_smc_M02_AXI_RRESP),
        .s_axil_init_rvalid(axi_smc_M02_AXI_RVALID),
        .s_axil_init_wdata(axi_smc_M02_AXI_WDATA),
        .s_axil_init_wready(axi_smc_M02_AXI_WREADY),
        .s_axil_init_wstrb(axi_smc_M02_AXI_WSTRB),
        .s_axil_init_wvalid(axi_smc_M02_AXI_WVALID),
