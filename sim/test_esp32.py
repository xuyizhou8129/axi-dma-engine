...
from serial_host import DMASerialHost, _crc32_words, run_golden, _find_arty_port
...
def test_scenario(host, scenario_csv, out_dir):
    ...
    # Clear ESP32 state from any prior test so stale smem/sram don't corrupt results
    host.reset()
